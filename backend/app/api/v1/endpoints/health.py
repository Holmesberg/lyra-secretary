...
The /health/env-invariants route is a LyraOS-specific probe that
...
def health_check():
    ...
    return {"status": "ok", "service": "lyraos-api"}
...
def env_invariants(
    ...
    """Probe LyraOS's environment assumptions and report any drift.
    ...
    # Why: LyraOS's internal convention is naive-UTC. Subtractions
