...
LYRA_OUTBOUND_EMAIL = "hello@lyraos.org"
LYRA_FROM_HEADER = f"LyraOS <{LYRA_OUTBOUND_EMAIL}>"
LYRA_USER_AGENT = "lyraos-email/1.0"
...
def send_resend_email(
    *,
    ...
    change, change LYRA_OUTBOUND_EMAIL here and update the invariant tests.
    """
