...
from app.services.email_delivery import LYRAOS_FROM_HEADER, send_resend_email
from app.services.email_engagement import (
    build_click_tracking_url,
    build_open_tracking_url,
)

SUBJECT = "Forgot about LyraOS?"
...
Quick one - did LyraOS slip off your radar?
...
LyraOS will take that mess and turn it into:
...
Please subscribe to get reminders so LyraOS can nudge you when it slips off your radar.
          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#13161e;border:1px solid #252836;">
            <tr>
              <td style="padding:28px 28px 8px;">
                ...
                <p style="margin:0 0 18px;font-size:16px;line-height:1.55;color:#e8eaf0;">Quick one - did LyraOS slip off your radar?</p>
                ...
                <p style="margin:0 0 10px;font-size:16px;line-height:1.55;color:#e8eaf0;">LyraOS will take that mess and turn it into:</p>
                ...
                <p style="margin:0 0 24px;font-size:15px;line-height:1.55;color:#c8ccda;">Please subscribe to get reminders so LyraOS can nudge you when it slips off your radar.</p>
                ...
                <p style="margin:0 0 14px;">
                  <a href="{click_url}" style="display:inline-block;background:#3bdcff;color:#071013;text-decoration:none;font-weight:700;font-size:14px;padding:12px 18px;border-radius:4px;">Open LyraOS</a>
                </p>
...
def _send_one(
    *,
    ...
    result = send_resend_email(
        ...
        idempotency_key=(
            f"lyraos-reactivation-{CAMPAIGN_VERSION}-{phase}-"
...
def main() -> int:
    ...
    print(f"from={LYRAOS_FROM_HEADER}")
