> **ARCHIVED 2026-04-29.** Second of the four strategic-decisions docs. Apr 22 + Apr 24 passes revisit several of these calls (Path B, archetype compliance fork, etc.) with later dogfood signal. Kept for the four-doc strategic chain; do not edit. Current canonical: `strategic_decisions_april_22.md` + `april_24.md`.
