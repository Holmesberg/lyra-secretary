> **ARCHIVED 2026-04-29.** Earliest of the four strategic-decisions docs. Subsequent passes (`strategic_decisions_april_21.md`, `april_22.md`, `april_24.md`) revisit + extend these calls with newer dogfood data. Kept for the four-doc strategic chain; do not edit. Current canonical: `april_22.md` + `april_24.md`.
