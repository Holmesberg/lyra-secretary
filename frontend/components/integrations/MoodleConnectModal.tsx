      ...
      <DialogContent className="max-w-lg">
        ...
        {step === "instructions" && (
          <div className="flex flex-col gap-4">
            <p className="text-sm text-dust">
              LyraOS reads from Moodle in two ways. We never write back, never
          ...
          <div className="flex flex-col gap-4">
            ...
            {showWsInput && (
              <div className="flex flex-col gap-2">
                ...
                <p className="text-[11px] text-dust">
                  Lets LyraOS check Moodle every 6h for submission evidence, and import past items LyraOS missed.
                </p>
                ...
                <div className="mt-1 flex items-center gap-1.5 rounded-sm border border-signal/25 bg-signal/5 px-2.5 py-1.5">
                  ...
                  <p className="text-[11px] font-medium text-parchment">
                    Encrypted before saving · stays on LyraOS&apos;s server, never shared.
                  </p>
                </div>
              </div>
            )}
        ...
        {step === "success" && (
          <div className="flex flex-col gap-4">
            ...
            <p className="text-[11px] text-dust">
              LyraOS checks Moodle every 6 hours. Disconnect anytime from Settings.
            </p>
            <div className="flex justify-end gap-2 pt-2">
