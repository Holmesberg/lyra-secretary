...
const STEPS: Array<{ title: string; body: string }> = [
  {
    title: "Welcome to LyraOS",
    body:
      "LyraOS measures how long your tasks actually take vs how long you thought they would. Over time you see the shape of your own planning — where you overrun, where you scope-inflate, where you're spot-on.",
  },
  {
    title: "Start from capture",
    body:
      "Use the Pulse capture bar to brain-dump tasks or obligations. LyraOS shows a preview first, so you can edit dates, keep or remove items, and confirm only what should become real.",
  },
  {
  ...
  },
  {
    title: "Stop + reflect",
    body:
      "When you stop a timer we ask how focused you felt during the run (1–5 again). The gap between readiness before and reflection after is one of the signals LyraOS tracks. It's not graded — it's data about you.",
  },
  {
    title: "Calendar view",
    body:
  ...
  },
  {
    ...
    body:
      "Settings → Integrations lets you connect Google Calendar if you want your external events alongside planned LyraOS tasks. Nothing is required. You'll never see a consent screen unless you click Connect.",
  },
  {
    title: "LyraOS stays out of your way",
    body:
