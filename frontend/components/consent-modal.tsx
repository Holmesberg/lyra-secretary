...
export function ConsentModal({ onAccepted }: { onAccepted: () => void }) {
  ...
  async function submit() {
    if (!terms) {
      setError("You must accept the Terms and Privacy Policy to use LyraOS.");
      return;
    }
    setSubmitting(true);
    setError(null);
    ...
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center p-4 z-50">
      ...
      >
        ...
        <p className="text-muted-foreground text-sm mb-6">
          LyraOS learns from how you plan and work to personalize your scheduler. Please review and accept.
        </p>
        ...
        <label className="flex items-start gap-3 mb-6 cursor-pointer">
          ...
          />
          <span className="text-sm">
            I allow my anonymized usage data to be used to improve LyraOS over time.{" "}
