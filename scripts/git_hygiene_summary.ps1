...
Write-Host "- browser account: <alinassersabry operator, alt account, logged-out public, or 'not applicable' with reason>"
Write-Host "- senior UI/UX pass: <feature/bug paths exercised, desktop/mobile screenshots, console/network/latency review>"
Write-Host "- data cleanup/void proof: <before/after counts, row IDs voided/deleted, or 'read-only/no mutation'>"
