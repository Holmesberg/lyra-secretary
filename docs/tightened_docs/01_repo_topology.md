...
| `backend/app/services/exposure_policy.py` | Exposure horizon policy config helper | governance/measurement-grade | Pure versioned policy loading and category horizon lookup; no behavioral row reads or writes |
