...
**PERMITTED: measurement-state progress framing.** This is structurally different from gamification and is a required Phase 4.5 Tier 1 shipping item (see `docs/building_phases.md`). Permitted surfaces:
